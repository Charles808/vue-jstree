<template>
    <li role="treeitem"
        ...
        <div id="tooltip-disable" :class="anchorClasses" @click="handleItemClick" @mouseover="handleItemHover" @mouseout="isHover=false">
        ...
        <b-tooltip :disabled.sync="tooltipDisabled" target="tooltip-disable">
            {{ tooltipMsg }}
        </b-tooltip>
